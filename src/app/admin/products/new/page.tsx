        ...
        <header className="flex flex-col gap-4 rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-zinc-400">
              Organize atributos, inventário e mídia antes de enviar ao
              catálogo.
            </p>
          </div>
          <div className="flex flex-wrap gap-3">
            <Link
              href="/admin"
              className="hover:border-primary/60 inline-flex items-center gap-2 rounded-2xl border border-white/20 px-4 py-2 text-sm text-zinc-200 transition hover:text-white"
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
              ...
              >
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="hover:border-primary/60 hover:text-primary rounded-2xl border border-white/10 px-4 py-3 text-sm text-white transition"
                  >
                    Gerar
                  </button>
                </div>
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <FormField label="Badge destacada">
                <input
                  className={inputClasses}
          ...
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
            ...
            <div className="mt-6 space-y-6">
              ...
              <FormField label="Benefícios (separe por vírgula)">
                <input
                  className={inputClasses}
              ...
              <FormField
                label="Especificações técnicas (JSON)"
                helper='Ex.: {"material":"Nylon"}'
              >
                <textarea
          ...
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
            ...
            <div className="mt-6 space-y-4">
                ...
                >
                  ...
                  <div className="mt-4 grid gap-4 md:grid-cols-2">
                    ...
                    <FormField label="Cor">
                      <input
                        className={inputClasses}
                        placeholder="Black Carbon"
                      />
                    </FormField>
                    <FormField label="Tamanho">
                      <input
                        className={inputClasses}
                        placeholder="41 / M / Único"
                      />
                    </FormField>
                  </div>
                  <div className="mt-4 grid gap-4 md:grid-cols-3">
                    ...
                    <FormField label="Preço antigo (R$)">
                      <input className={inputClasses} type="number" min={0} />
                    </FormField>
                    <FormField label="Estoque disponível" required>
                      <input
                        className={inputClasses}
                        type="number"
                        min={0}
              ...
              <button
                ...
                className="hover:border-primary/60 flex w-full items-center justify-center gap-2 rounded-2xl border border-dashed border-white/20 py-3 text-sm text-zinc-300 transition hover:text-white"
              >
          ...
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-2xl border border-dashed border-white/15 bg-black/30 p-6 text-center text-sm text-zinc-400">
                <ImageIcon className="text-primary mx-auto mb-3 h-6 w-6" />
          ...
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <p className="text-xs text-zinc-500">
                Dica: utilize status rascunho para trabalhar com squad de mídia
                antes de liberar ao público.
              </p>
              <button
                type="submit"
                disabled={isSubmitting}
                className="bg-primary/90 hover:bg-primary inline-flex items-center gap-2 rounded-2xl px-5 py-3 text-sm font-semibold tracking-[0.2em] text-black uppercase transition disabled:cursor-not-allowed disabled:opacity-70"
              >
                {isSubmitting ? (
                  <>
