          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute top-1/2 left-4 h-5 w-5 -translate-y-1/2 text-zinc-400" />
                <input
                  id="name"
                  name="name"
                  type="text"
            ...
            <div>
              <label className="flex cursor-pointer items-start gap-2">
                <input
                  type="checkbox"
                  required
                  className="text-primary focus:ring-primary mt-1 h-4 w-4 rounded border-zinc-700 bg-black/50 focus:ring-offset-0"
                />
